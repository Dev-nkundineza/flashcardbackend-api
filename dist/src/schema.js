...
const types = __importStar(require("./graphql/flashcard"));
const usertypes = __importStar(require("./graphql/users"));
const authTypes = __importStar(require("./graphql/authFolder"));
